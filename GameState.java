...
/**
 * Class to represent the state of a game of Othello. The state is defined by a
 * 2-dimensional
...
public class GameState {
	...
	int currentPlayer; // The player who is next to put a token on the board. Value is 1 or 2.
	private int size; // The number of columns = the number of rows on the board

	// ************ Constructors ****************//
	/**
	 * Initializes a square board with the number of columns and rows equal to the
	 * given size.
	 * The two middle positions on the left-leaning diagonal contains tokens for
	 * black (player 1),
	 * the two middle positions on the right-leaning diagonal contains token for
	 * white (player 2).
	 * 
	 * @param size          Number of columns (and number of rows) in the board.
	 *                      Should be an even number
	 *                      greater or equal to 4.
	 * @param playerToStart The player who will go first. Should be 1 (black) or 2
	 *                      (white).
	 */
	...
	/**
	 * Constructs a new game state that equals the one represented by the supplied
	 * board and player.
	 * 
	 * @param board            The 2 dimensions of the array should have equal
	 *                         length, and possible values should be
	 *                         0 (empty), 1 (black) or 2 (white).
	 * @param playerToTakeTurn The player who will be the first to take a turn.
	 *                         Should be 1 (black)
	 *                         or 2 (white)
	 */
